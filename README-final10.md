...
- We have information of bill amount for six month (from April to September). Here we give probability of defautl only for two of them, September and April, which are more important with attention to SHAP and feature imporatnce.
...
1. <span style="color: red; "> main part of bill amonunt (Inter Quantile Range (IQR) for all six months is between 4000 to 5000 dollars</span>  
2.   <span style="color: red; "> 25%, 50% and 75% quatiles decreases, as the previous month increases  
...
#### 2- <span style="color: red; "> **Data udnerstanding** </span> 
