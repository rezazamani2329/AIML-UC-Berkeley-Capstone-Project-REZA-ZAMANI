...
-![accuracy, classification report](Classifiers Comparison.png) 
- 4- Plotting ROC curve
- ![ROC_AUC](ROC_AUC.png)
- 5- Confusion Matrix
- ![confusion matix1](Confusion matrix 1.png)
-  ![confusion matix2](Confusion matrix 2.png)

- 6- SHAP and feature importance
-  ![Feature importance KNN](Feature importance KNN.png)
